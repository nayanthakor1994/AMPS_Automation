...
public class AddProjectWorkflowPage extends BasePage {
	...
	By addProjectApprovals = By.xpath("//*[normalize-space()='Project Approvals' or normalize-space()='Project Forms']/..//a[normalize-space()='Add new record']");
	...
	By drpSelectTemplate = By.xpath("//*[normalize-space()='Select Templates']/..//input[contains(@id,'idManageApproval_customFields')]");
	...
	By tabDocument = By.xpath("//div[@id='idManageApproval_tabStrip']//a[normalize-space()='Documents' and not(contains(@class,'rtsDisabled'))]");
	By tabNotes = By.xpath("//div[@id='idManageApproval_tabStrip']//a[normalize-space()='Notes' and not(contains(@class,'rtsDisabled'))]");
	By tabLinkedApprovals = By.xpath("//div[@id='idManageApproval_tabStrip']//a[normalize-space()='Linked Approvals' and not(contains(@class,'rtsDisabled'))]");
	By tabAssociatedRecords = By.xpath("//div[@id='idManageApproval_tabStrip']//a[normalize-space()='Associated Records' and not(contains(@class,'rtsDisabled'))]");
	...
	By addedApprovedNote = By.xpath("//table[contains(@id,'idManageApproval_NOTES_radYALGridControl')]//td[contains(.,'Approved')]");
	
	//Associated records
	By drpAddProjects = By.xpath("//*[normalize-space()='Projects:']/../following-sibling::tr//input[@id='idManageApproval_Projects_Input']");
	By drpAddProjectsClose = By.xpath("//*[normalize-space()='Projects:']/../following-sibling::tr//a[contains(@id,'Approval_Projects_Arrow')]");
	By drpListOfTrack = By.xpath("//*[normalize-space()='List of Tract:']/../following-sibling::tr//input[@id='idManageApproval_Tract_Agreement_Input']");
	By drpListOfTrackClose = By.xpath("//*[normalize-space()='List of Tract:']/../following-sibling::tr//a[contains(@id,'Tract_Agreement_Arrow')]");
	...
	By btnRefreshListTract = By.xpath("//table[contains(@id,'idManageApproval_ASSOCIATED_APPROVAL_TRACTS')]//a[contains(@id,'_lnkRefresh')]");
	...
	public void selectReportFormat(String value) {
		By radioButton = By.xpath("//*[normalize-space()='Report format']/..//label[text()='"+value+"']/preceding-sibling::input");
...
//		waituntill loader gone
		...
		clickOnSaveNote();
//		getNotesMessage(); //Assertion : Note submitted and auto-approved.
